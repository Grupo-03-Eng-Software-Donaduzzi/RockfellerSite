...
// Courses to insert
const cursos = [
    { label: "Inglês kids", link: "HTML/kids.html" },
    { label: "Inglês teens", link: "HTML/teens.html" },
    { label: "Inglês adults", link: "HTML/adults.html" },
    { label: "Todos os cursos", link: "HTML/cursos.html" }
];
